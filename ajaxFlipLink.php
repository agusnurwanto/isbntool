...
function get_datatables($id=false){
	$content = file_get_contents('database/flipLink.json');
	// $content = file_get_contents("https://fultonfile-agusnurwanto.rhcloud.com/tmp/json/flipLink.json");
...
if(!empty($_GET["add"])){
    ...
    $dt["content"][] = $data;
	putContent(array("folder"=>"json", "file"=>"flipLink.json", "content"=>json_encode($dt["content"])));
...
if(!empty($_GET["update"])){
	...
	putContent(array("folder"=>"json", "file"=>"flipLink.json", "content"=>json_encode($data["content"])));
...
if(!empty($_GET["delete"])){
	...
	putContent(array("folder"=>"json", "file"=>"ajaxFlipLink.php", "content"=>json_encode($newData)));
	die(json_encode(array("status" => TRUE)));
}
